...
<div class="row">
   ...
   <div class="row my-4">
        ...
        <div class="col-md-12">
                  ...
                  <input type="text" id="example-readonly" class="form-control" readonly="" value="{{$getMyRenterComplain['subject']}}"> 
          </div> 
         ...
         <div class="col-md-12">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('AddResponse') }}" method="POST">
                    @csrf
           ...
           <div class="form-group">
                  ...
                  <textarea class="form-control bg-light" id="exampleFormControlTextarea1" rows="2" name="RS_Office_response" required></textarea>
                   ...
                   <input type="hidden" name="CompainID" value="  {{$getMyRenterComplain['id']}}"  /> 
                  </div>
